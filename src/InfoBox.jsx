...
export default function InfoBox ({ info }) {
    ...
    const COLD_URL = 
    "https://images.unsplash.com/photo-1564314968303-86c5df2b9a4c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Q29sZCUyMHdlYXRoZXJ8ZW58MHx8MHx8fDA%3D";
    const RAIN_URL = 
    ...
    return (
      ...
      <CardContent>
        ...
        <p>The Weather cam be described as <i>{info.weather}</i> feels like {info.feelslike}&deg;C</p>
        </Typography>
      </CardContent>
    </Card>
      </div>
